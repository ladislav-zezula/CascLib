...
static CASC_ENCRYPTION_KEY CascKeys[] =
{
  ...
  // { 0x493455579DA0B18EULL, { 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x?? } },   // 1.19.3.1.43036
  // { 0x6362C5AD65DAE686ULL, { 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x?? } },   // 1.19.3.1.43036
