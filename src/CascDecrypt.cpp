...
static CASC_ENCRYPTION_KEY CascKeys[] =
{
  ...
  { 0xF6CF23955B5D437DULL, { 0xAE, 0xBA, 0x22, 0x73, 0x28, 0xA5, 0xB0, 0xAA, 0x9F, 0x51, 0xDA, 0xE3, 0xF6, 0xA7, 0xDF, 0xE4 } },   // 1.17.0.0.????? Moira
  ...
  //  { 0xBF3734B1DCB04696ULL, {0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x?? } },   // 104 WOW-25079patch7.3.2_PTR legion_73_afn
