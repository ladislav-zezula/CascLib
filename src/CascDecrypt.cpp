...
static CASC_ENCRYPTION_KEY CascKeys[] =
{
  ...
  // { 0x82297FBAB7F5EB80ULL, {0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??}},   // 1.19.1.3.42563
  // { 0x9ADF00AA1A174A69ULL, {0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??}},   // 1.19.1.3.42563
  // { 0xCFA05AA76B49F881ULL, {0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??}},   // 1.19.1.3.42563
  ...
  //  { 0xB1EB52A64BFAF7BFULL, { 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x?? } },   // 115 WOW-25600patch7.3.5_PTR dogmount, 50 files
  //  { 0xFC6F20EE98D208F6ULL, { 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x?? } },   // 117 WOW-25632patch7.3.5_PTR  shop stuff
  //  { 0x402CFABF2020D9B7ULL, { 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x?? } },   // 118 WOW-25678patch7.3.5_PTR  filedataid 1854762
