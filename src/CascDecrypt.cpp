...
static CASC_ENCRYPTION_KEY CascKeys[] =
{
  ...
  // { 0xE6D914F8E4744953ULL, {0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??}},   // 1.13.0.0.37646 Doomfist related (needs confirmation)
  // { 0x21DBFD65F3E54269ULL, {0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??}},   // 1.13.0.0.37646 Summer Games 2017 (needs confirmation)
  // { 0x5694C503F8C80178ULL, {0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??}},   // 1.13.0.0.37646
