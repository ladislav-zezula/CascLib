...
copy /Y /D .\src\CascLib.h            ..\aaa\inc >nul
copy /Y /D .\src\CascPort.h           ..\aaa\inc >nul    
copy /Y /D .\bin\CascLib\%2\%5\%4.lib ..\aaa\%3\%4.lib >nul
copy /Y /D .\bin\CascLib\%2\%5\%4.pdb ..\aaa\%3\%4.pdb >nul
